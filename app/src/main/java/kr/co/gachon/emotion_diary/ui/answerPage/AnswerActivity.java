    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.room_button).setOnClickListener(v -> {
            if (finalParsedDate != null) {
                Diary diary = new Diary(title, content, finalParsedDate, Emotions.getEmotionIdByText(emotion), -1, null);
        ...
        if (!helper.checkNetworkState()) {
            Toast.makeText(AnswerActivity.this, "Wi-Fi가 없습니다.", Toast.LENGTH_SHORT).show();
        }
    }
}
